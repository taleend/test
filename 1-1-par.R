#----b0, b1, b2, b3, k parameter simulation
#----This code simulate data and then estimate parameters. 
#----I set up multiple initial k values. 
#----The estimated parameters save to the file: 1-simpar-dif k. txt
...
#----read table: read.table("1-simpar-dif k.txt",header=T)
