...
for (i in 1:3)
{
 x1[,i] <- density(GFYF[,i])$x
 y1[,i] <- density(GFYF[,i])$y
}
...
for (i in 1:3)
{
 x2[,i] <- density(GFYT[,i])$x
 y2[,i] <- density(GFYT[,i])$y
}
...
for (i in 1:3)
{
 x3[,i] <- density(GTYF[,i])$x
 y3[,i] <- density(GTYF[,i])$y
}
...
for (i in 1:3)
{
 x4[,i] <- density(GTYT[,i])$x
 y4[,i] <- density(GTYT[,i])$y
}
